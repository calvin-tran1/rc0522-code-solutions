...
console.log('value of anObject:', typeof anObject);

var anArray = new Array();
console.log('value of anArray:', anArray);
console.log('value of anArray:', typeof anArray);

var aFunction = new Function();
console.log('value of aFunction:', aFunction);
console.log('value of aFunction:', typeof aFunction);
...
console.log('value of aBoolean:', typeof aBoolean);

var aString = new String();
console.log('value of aString:', aString);
console.log('value of aString:', typeof aString);
